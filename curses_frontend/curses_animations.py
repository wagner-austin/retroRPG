...
# version: 1.4
#
# Summary: Houses drawing routines for sprite/scene animations (ASCII border, ASCII art, etc.).
#
...
def draw_art(stdscr: curses.window, art_lines: list[str], start_row: int = 1, start_col: int = 2,
